...
def test_slit_offset(setup_integration_env):
    ...
    prof_01 = os.path.join(OUTPUT_DIR, "Profiles", "SongMultiCam", "Cam_Grid2_01.json")
...
def test_effect_script_loading():
    ...
    # Check Grid 1
    path_g1 = os.path.join(output_dir, "Profiles", "SongMultiCam", "Cam_Grid1_01.json")
    assert os.path.exists(path_g1), "Grid 1 profile should exist (schedule 0-1s)"
    
    # Check Grid 2 (4 cameras)
    path_g2_01 = os.path.join(output_dir, "Profiles", "SongMultiCam", "Cam_Grid2_01.json")
    path_g2_04 = os.path.join(output_dir, "Profiles", "SongMultiCam", "Cam_Grid2_04.json")
    ...
    path_g3 = os.path.join(output_dir, "Profiles", "SongMultiCam", "Cam_Grid3_01.json")
